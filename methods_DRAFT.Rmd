...
biomes = c("Tropical_wet","Temperate_wet","Tundra","Temperate_dry","Tropical_dry","Mangroves"),
...
biomes_pred2$biomes<-factor(biomes_pred2$biomes,levels=c("Tropical_wet","Tropical_dry","Temperate_wet","Temperate_dry","Tundra","Mangroves"))
