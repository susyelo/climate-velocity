...
biome.col2 <- c("darkorchid","red", "yellow", "darkgreen")
```
...
biomes_pred2$Period<- factor(biomes_pred2$Period,levels=c("pew","tee","mco","mce","pwe","pir"))

ggplot(biomes_pred2, aes(x=Period, y=Prop, group=biomes)) +
  geom_line(aes(color=biomes))+
